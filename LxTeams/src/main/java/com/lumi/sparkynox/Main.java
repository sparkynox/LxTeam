package com.lumi.sparkynox;

import com.lumi.sparkynox.commands.CreatorCommand;
import com.lumi.sparkynox.commands.HelpCommand;
import com.lumi.sparkynox.commands.LxTeamCommand;
import com.lumi.sparkynox.commands.ParentCommand;
import com.lumi.sparkynox.commands.PermissionParentCommand;
import com.lumi.sparkynox.gui.CreatorGUI;
import com.lumi.sparkynox.gui.TeamGUI;
import com.lumi.sparkynox.commands.team.*;
import com.lumi.sparkynox.commands.team.chest.ChestCheckCommand;
import com.lumi.sparkynox.commands.team.chest.ChestClaimCommand;
import com.lumi.sparkynox.commands.team.chest.ChestRemoveCommand;
import com.lumi.sparkynox.commands.team.chest.ChestRemoveallCommand;
import com.lumi.sparkynox.commands.teama.*;
import com.lumi.sparkynox.commands.teama.chest.*;
import com.lumi.sparkynox.commands.teama.meta.MetaGetTeama;
import com.lumi.sparkynox.commands.teama.meta.MetaRemoveTeama;
import com.lumi.sparkynox.commands.teama.meta.MetaSetTeama;
import com.lumi.sparkynox.commands.teama.money.AddMoney;
import com.lumi.sparkynox.commands.teama.money.RemoveMoney;
import com.lumi.sparkynox.commands.teama.money.SetMoney;
import com.lumi.sparkynox.commands.teama.score.AddScore;
import com.lumi.sparkynox.commands.teama.score.RemoveScore;
import com.lumi.sparkynox.commands.teama.score.SetScore;
import com.lumi.sparkynox.cooldown.CooldownManager;
import com.lumi.sparkynox.cost.CostManager;
import com.lumi.sparkynox.customEvents.post.PostBetterTeamsReloadEvent;
import com.lumi.sparkynox.events.*;
import com.lumi.sparkynox.events.MCTeamManagement.BelowNameType;
import com.lumi.sparkynox.extension.ExtensionManager;
import com.lumi.sparkynox.integrations.UltimateClaimsManager;
import com.lumi.sparkynox.integrations.WorldGuardManagerV7;
import com.lumi.sparkynox.integrations.apollo.ApolloManager;
import com.lumi.sparkynox.integrations.hologram.DHHologramManager;
import com.lumi.sparkynox.integrations.hologram.HDHologramManager;
import com.lumi.sparkynox.integrations.hologram.HologramManager;
import com.lumi.sparkynox.integrations.placeholder.TeamPlaceholders;
import com.lumi.sparkynox.message.MessageManager;
import com.lumi.sparkynox.score.ScoreManagement;
import com.lumi.sparkynox.team.level.LevelManager;
import com.lumi.sparkynox.team.storage.StorageType;
import com.lumi.sparkynox.team.storage.convert.Converter;
import com.lumi.sparkynox.team.storage.storageManager.SeparatedYamlStorageManager;
import com.lumi.sparkynox.team.storage.storageManager.YamlStorageManager;
...
public class Main extends JavaPlugin {
	...
	public void setupCommands() {
		teamCommand = new PermissionParentCommand(new CostManager("lxteam"), new CooldownManager("lxteam"), "lxteam");
		...
		teamBooksawCommand = new BooksawCommand("lxteam", teamCommand, "betterteams.standard", "All commands for teams",
				getConfig().getStringList("command.lxteam"));
	...
	public void setupListeners() {
		...
		// LxTeams GUI listeners
		getServer().getPluginManager().registerEvents(new TeamGUI(), this);
		getServer().getPluginManager().registerEvents(new CreatorGUI(), this);
